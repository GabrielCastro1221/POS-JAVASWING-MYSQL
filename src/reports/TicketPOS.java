...
public class TicketPOS {
    ...
    public static void imprimirTicket(int idVenta) {
        try {
            ...
            ticket.append("Ticket No: ").append(venta.getId()).append("\n");
            ...
            ticket.append("--------------------------------\n");
            double subtotal = venta.getTotal() / 1.19;
            double iva = venta.getTotal() - subtotal;
            ticket.append(String.format("Subtotal: %16.2f\n", subtotal));
            ticket.append(String.format("IVA (19%%): %15.2f\n", iva));
